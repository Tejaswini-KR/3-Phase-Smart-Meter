...
{
	/* 00 - Single Action Schedule -Image Activation */
	{ 
		{0,   0,   15,   0,   2,   255},
	...
	/* 01 - Single action schedule- Billing Push */
	{ 
		{0,   0,   15,   0,   0,   255},
	...
	/* 02 - Schedule for push - SM to IHD Push */
	{ 
		{0,   3,   15,   0,   4,   255},
		(access_right_t *)g_objects_access_right_table[17],
	...
	/* 03 - Single Action Schedule - SM to HES Push */
	{ 
		{0,   0,   15,   0,   4,   255},
		(access_right_t *)g_objects_access_right_table[17],
