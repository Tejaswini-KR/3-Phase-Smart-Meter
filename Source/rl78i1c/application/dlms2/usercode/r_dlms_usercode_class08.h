...
*******************************************************************************
* File Name    : r_dlms_usercode_class08.h
...
#ifndef R_DLMS_USERCODE_CLASS08_H
#define R_DLMS_USERCODE_CLASS08_H
...
uint8_t R_DLMS_USER_ic08_obj00_att02_set(distributor_params_t * p_params, date_time_t * p_attribute_get);
uint8_t R_DLMS_USER_ic08_obj00_att03_get(distributor_params_t * p_params, int16_t * p_attribute_get);
uint8_t R_DLMS_USER_ic08_obj00_att03_set(distributor_params_t * p_params, int16_t * p_attribute_get);
...
#endif /* R_DLMS_USERCODE_CLASS08_H */