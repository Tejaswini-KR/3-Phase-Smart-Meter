 ...
 */
#define     LCD_RAM_START_ADDRESS   0xf0404 /* LCD Memory Start Address */
#define     LCD_RAM_END_ADDRESS     0xf0419 /* LCD Memory End Address */
...
void LCD_WriteRAMSignInfo(uint16_t ram_addr, uint8_t disp_value);
void LCD_ClearRAMSignInfo(uint16_t ram_addr, uint8_t disp_value);
