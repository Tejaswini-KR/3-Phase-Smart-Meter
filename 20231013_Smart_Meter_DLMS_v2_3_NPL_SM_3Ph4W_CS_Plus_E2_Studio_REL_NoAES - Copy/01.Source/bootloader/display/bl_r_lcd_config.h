 ...
 */
#define     LCD_NUM_DIGIT_CHAR      11      /* number of displayable char for a digit (0..9, A..F, -) */
#define     LCD_NUM_DIGIT           7       /* number of digits in LCD panel */
...
/* Reduce the number of character definitions to reduce code size */
#define     LCD_NUMB_0              0       /* Display number 0 on LCD */
#define     LCD_NUMB_5              1       /* Display number 5 on LCD */
#define     LCD_CHAR_A              2       /* Display character A on LCD */
#define     LCD_CHAR_B              3       /* Display character b on LCD */
#define     LCD_CHAR_C              4       /* Display character C on LCD */
#define     LCD_CHAR_D              5       /* Display character d on LCD */
#define     LCD_CHAR_E              6       /* Display character E on LCD */
#define     LCD_CHAR_P              7       /* Display character P on LCD */
#define     LCD_CHAR_U              8       /* Display character U on LCD */
#define     LCD_CHAR_T              9       /* Display character t on LCD */
#define     LCD_CHAR_R              10      /* Display character r on LCD */
...
Variable Externs
***********************************************************************************************************************/
extern const FAR_PTR LCD_NUM_MAP        g_LCD_NumMap[]; 
extern const FAR_PTR LCD_NUM_TYPE_VALUE g_LCD_NumType[];
extern const FAR_PTR LCD_SIGN_MAP       g_LCD_SignMap[];
extern const FAR_PTR LCD_DECIMAL_INFO   g_DecInfo;
extern const FAR_PTR LCD_DECIMAL_INFO   g_DecInfo1;
