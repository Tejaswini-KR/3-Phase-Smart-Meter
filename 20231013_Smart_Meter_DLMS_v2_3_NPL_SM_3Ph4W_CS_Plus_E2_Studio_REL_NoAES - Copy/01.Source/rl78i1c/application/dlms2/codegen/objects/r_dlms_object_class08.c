...
/******************************************************************************	
* File Name    : r_dlms_object_class08.c
* Version      : 2.00
...
/*---------------------------------------------------------------------------*/
/*Class 08 record table*/
/*---------------------------------------------------------------------------*/
const class08_child_record_t	g_objects_child_table_class08[] =
{
	/* 00 - RTC Clock */
	{ 
		{0,   0,   1,   0,   0,   255},
		(access_right_t *)g_objects_access_right_table[7],
		NULL,
		NULL,
		NULL,
		NULL,
...
const uint16_t 	g_objects_child_table_class08_length = sizeof(g_objects_child_table_class08) / sizeof(class08_child_record_t);



/******************************************************************************
* Function Name : R_DLMS_OBJECTS_Class08Distributor
* Interface     : void R_DLMS_OBJECTS_Class08Distributor(
*               :     distributor_params_t * p_param,
*               : );
* Description   : User distributor function for GET/SET/ACTION service of class 08
			...
			case 2:
				if (p_params->distributor_state == DIST_BEFORE_CLASS_FUNCTION)
				{
					...
					switch(p_params->child_index)
					{
						case 0:
							/* Clone new attribute */
							R_DLMS_IC08_REDIRECT_02(p_params, p_class08_obj->p_time);
							/* APPLICATION */
							result = R_DLMS_USER_ic08_obj00_att02_get(p_params, p_class08_obj->p_time);
							break;
			...
			case 3:
				if (p_params->distributor_state == DIST_BEFORE_CLASS_FUNCTION)
				{
					...
					switch(p_params->child_index)
					{
						case 0:
							/* Clone new attribute */
							R_DLMS_IC08_REDIRECT_03(p_params, p_class08_obj->p_time_zone);
							/* APPLICATION */
							result = R_DLMS_USER_ic08_obj00_att03_get(p_params, p_class08_obj->p_time_zone);
							break;
			...
			case 4:
				if (p_params->distributor_state == DIST_BEFORE_CLASS_FUNCTION)
				{
					...
					switch(p_params->child_index)
					{
						case 0:
							/* Clone new attribute */
							R_DLMS_IC08_REDIRECT_04(p_params, p_class08_obj->p_status);
							/* APPLICATION */
							result = R_DLMS_USER_ic08_obj00_att04_get(p_params, p_class08_obj->p_status);
							break;
			...
			case 5:
				if (p_params->distributor_state == DIST_BEFORE_CLASS_FUNCTION)
				{
					...
					switch(p_params->child_index)
					{
						case 0:
							/* Clone new attribute */
							R_DLMS_IC08_REDIRECT_05(p_params, p_class08_obj->p_daylight_savings_begin);
							/* APPLICATION */
							result = R_DLMS_USER_ic08_obj00_att05_get(p_params, p_class08_obj->p_daylight_savings_begin);
							break;
			...
			case 6:
				if (p_params->distributor_state == DIST_BEFORE_CLASS_FUNCTION)
				{
					...
					switch(p_params->child_index)
					{
						case 0:
							/* Clone new attribute */
							R_DLMS_IC08_REDIRECT_06(p_params, p_class08_obj->p_daylight_savings_end);
							/* APPLICATION */
							result = R_DLMS_USER_ic08_obj00_att06_get(p_params, p_class08_obj->p_daylight_savings_end);
							break;
			...
			case 7:
				if (p_params->distributor_state == DIST_BEFORE_CLASS_FUNCTION)
				{
					...
					switch(p_params->child_index)
					{
						case 0:
							/* Clone new attribute */
							R_DLMS_IC08_REDIRECT_07(p_params, p_class08_obj->p_daylight_savings_deviation);
							/* APPLICATION */
							result = R_DLMS_USER_ic08_obj00_att07_get(p_params, p_class08_obj->p_daylight_savings_deviation);
							break;
			...
			case 8:
				if (p_params->distributor_state == DIST_BEFORE_CLASS_FUNCTION)
				{
					...
					switch(p_params->child_index)
					{
						case 0:
							/* Clone new attribute */
							R_DLMS_IC08_REDIRECT_08(p_params, p_class08_obj->p_daylight_savings_enabled);
							/* APPLICATION */
							result = R_DLMS_USER_ic08_obj00_att08_get(p_params, p_class08_obj->p_daylight_savings_enabled);
							break;
			...
			case 9:
				if (p_params->distributor_state == DIST_BEFORE_CLASS_FUNCTION)
				{
					...
					switch(p_params->child_index)
					{
						case 0:
							/* Clone new attribute */
							R_DLMS_IC08_REDIRECT_09(p_params, p_class08_obj->p_clock_base);
							/* APPLICATION */
							result = R_DLMS_USER_ic08_obj00_att09_get(p_params, p_class08_obj->p_clock_base);
							break;
		...
		switch (p_params->descriptor.attr.attribute_id)
		{
			case 2:
			      ...
			      (p_params->service_params.decode_success == TRUE))
				{
					...
					{
						case 0:
							result = R_DLMS_USER_ic08_obj00_att02_set(p_params, (void *)p_params->service_params.malloc.p_content);
							break;
			...
			case 3:
			      ...
			      (p_params->service_params.decode_success == TRUE))
				{
					...
					{
						case 0:
							result = R_DLMS_USER_ic08_obj00_att03_set(p_params, (void *)p_params->service_params.malloc.p_content);
							break;
