...
{	
    ...
    */
    ...
    /* HOCO Trimming */
    if (DATAFLASH_Write(CONFIG_STORAGE_CALIB_DRIVER_HOCO_TRIM_ADDR, 
                       (uint8_t *)&HIOTRM,
                       CONFIG_STORAGE_CALIB_DRIVER_HOCO_TRIM_SIZE    ) != DATAFLASH_OK)			
    {
        return CONFIG_ERROR;   /* Write error */
    }
    R_WDT_Restart();
...
CFS_FUNC uint8_t CONFIG_Format(void)
{
    ...
    /* Init default trimming for HOCO */
    HIOTRM = EM_CALIB_DEFAULT_HOCO_TRIMMING;
...
{	
    ...
    */
    ...
    /* HOCO Trimming */
    if (DATAFLASH_Read(CONFIG_STORAGE_CALIB_DRIVER_HOCO_TRIM_ADDR, 
                       (uint8_t *)&HIOTRM,
                       CONFIG_STORAGE_CALIB_DRIVER_HOCO_TRIM_SIZE) != DATAFLASH_OK)				
    {
        return CONFIG_ERROR;   /* Read error */
