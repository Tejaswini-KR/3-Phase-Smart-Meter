...
#@   -c
#@   -MAKEUD=Release
#@   -exec_time=C:\Users\Tejaswini.kr\AppData\Local\Temp\CSPlusBuildTool_8a3f7b895c3e4f42aae3ba2acef8e4a3ok2ijaxg.cra
...
_BL_HASHING_Init:
	...
	.LINE "E:/SM_3phase/New folder/20231013_Smart_Meter_DLMS_v2_3_NPL_SM_3Ph4W_CS_Plus_E2_Studio_REL_NoAES - Copy/01.Source/bootloader/core/bl_hashing.c", 81
	clrw ax
	decw ax
	br !_R_CRC_Set
.LFE1:
...
_BL_HASHING_Calculate:
	...
	.LINE "E:/SM_3phase/New folder/20231013_Smart_Meter_DLMS_v2_3_NPL_SM_3Ph4W_CS_Plus_E2_Studio_REL_NoAES - Copy/01.Source/bootloader/core/bl_hashing.c", 91
	br !_R_CRC_Calculate
.LFE2:
	.TYPE _BL_HASHING_GetResult,function,.LFE3-_BL_HASHING_GetResult
_BL_HASHING_GetResult:
	.STACK _BL_HASHING_GetResult = 8
	.LINE "E:/SM_3phase/New folder/20231013_Smart_Meter_DLMS_v2_3_NPL_SM_3Ph4W_CS_Plus_E2_Studio_REL_NoAES - Copy/01.Source/bootloader/core/bl_hashing.c", 102
	push hl
	push ax
	.LINE "E:/SM_3phase/New folder/20231013_Smart_Meter_DLMS_v2_3_NPL_SM_3Ph4W_CS_Plus_E2_Studio_REL_NoAES - Copy/01.Source/bootloader/core/bl_hashing.c", 107
	...
	incw ax
	incw ax
	.LINE "E:/SM_3phase/New folder/20231013_Smart_Meter_DLMS_v2_3_NPL_SM_3Ph4W_CS_Plus_E2_Studio_REL_NoAES - Copy/01.Source/bootloader/core/bl_hashing.c", 110
	movw bc, ax
	movw ax, [sp+0x00]
	movw de, #0x0002
	call !_BL_memcpy_nn
...
_BL_HASHING_DigestUserAppBackupSFL:
	...
	.LINE "E:/SM_3phase/New folder/20231013_Smart_Meter_DLMS_v2_3_NPL_SM_3Ph4W_CS_Plus_E2_Studio_REL_NoAES - Copy/01.Source/bootloader/core/bl_hashing.c", 139
	ret
.LFE4:
...
_BL_HASHING_DigestUserAppROM:
	...
	.LINE "E:/SM_3phase/New folder/20231013_Smart_Meter_DLMS_v2_3_NPL_SM_3Ph4W_CS_Plus_E2_Studio_REL_NoAES - Copy/01.Source/bootloader/core/bl_hashing.c", 153
	ret
.LFE5:
