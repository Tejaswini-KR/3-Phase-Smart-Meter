...
#@   -c
#@   -MAKEUD=Release
#@   -exec_time=C:\Users\Tejaswini.kr\AppData\Local\Temp\CSPlusBuildTool_e131a671c9c349908cbd2d4e5df91191toytydeh.2ds
...
_WRP_SPI_Init:
	...
	.LINE "E:/SM_3phase/New folder/20231013_Smart_Meter_DLMS_v2_3_NPL_SM_3Ph4W_CS_Plus_E2_Studio_REL_NoAES - Copy/01.Source/bootloader/wrapper/bl_wrp_user_spi.c", 74
	ret
.LFE1:
	.TYPE _WRP_SPI_Start,function,.LFE2-_WRP_SPI_Start
_WRP_SPI_Start:
	.STACK _WRP_SPI_Start = 4
	.LINE "E:/SM_3phase/New folder/20231013_Smart_Meter_DLMS_v2_3_NPL_SM_3Ph4W_CS_Plus_E2_Studio_REL_NoAES - Copy/01.Source/bootloader/wrapper/bl_wrp_user_spi.c", 88
	br !_R_CSI30_Start
.LFE2:
	.TYPE _WRP_SPI_Stop,function,.LFE3-_WRP_SPI_Stop
_WRP_SPI_Stop:
	.STACK _WRP_SPI_Stop = 4
	.LINE "E:/SM_3phase/New folder/20231013_Smart_Meter_DLMS_v2_3_NPL_SM_3Ph4W_CS_Plus_E2_Studio_REL_NoAES - Copy/01.Source/bootloader/wrapper/bl_wrp_user_spi.c", 100
	br !_R_CSI30_Stop
.LFE3:
	.TYPE _WRP_SPI_SendReceive,function,.LFE4-_WRP_SPI_SendReceive
_WRP_SPI_SendReceive:
	.STACK _WRP_SPI_SendReceive = 4
	.LINE "E:/SM_3phase/New folder/20231013_Smart_Meter_DLMS_v2_3_NPL_SM_3Ph4W_CS_Plus_E2_Studio_REL_NoAES - Copy/01.Source/bootloader/wrapper/bl_wrp_user_spi.c", 113
	call !_R_CSI30_Send_Receive
	.LINE "E:/SM_3phase/New folder/20231013_Smart_Meter_DLMS_v2_3_NPL_SM_3Ph4W_CS_Plus_E2_Studio_REL_NoAES - Copy/01.Source/bootloader/wrapper/bl_wrp_user_spi.c", 115
	clrw bc
	cmpw ax, bc
	oneb a
	sknz
...
_WRP_SPI_SendEndCallback:
	...
	.LINE "E:/SM_3phase/New folder/20231013_Smart_Meter_DLMS_v2_3_NPL_SM_3Ph4W_CS_Plus_E2_Studio_REL_NoAES - Copy/01.Source/bootloader/wrapper/bl_wrp_user_spi.c", 135
...
_WRP_SPI_ReceiveEndCallback:
	...
	.LINE "E:/SM_3phase/New folder/20231013_Smart_Meter_DLMS_v2_3_NPL_SM_3Ph4W_CS_Plus_E2_Studio_REL_NoAES - Copy/01.Source/bootloader/wrapper/bl_wrp_user_spi.c", 148
