 ...
 */
#define     LCD_NUM_DIGIT_CHAR      38      /* number of displayable char for a digit (0..9, A..F, -) */
#define     LCD_NUM_DIGIT           14       /* number of digits in LCD panel */
#define     LCD_NUM_SIGN            47      /* number of sign in LCD panel */
...
extern const LCD_NUM_TYPE_VALUE g_LCD_NumType_SET1[];
extern const LCD_NUM_TYPE_VALUE g_LCD_NumType_SET2[];
extern const LCD_NUM_TYPE_VALUE g_LCD_NumType_SET3[];
